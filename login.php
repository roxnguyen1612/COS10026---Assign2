                ...
                <div class="col-8">
                    <div class="card rounded text-center p-5">
                        <form class="card-body" method="post" action="login.php">
                            ...
                            <button class="btn btn-primary btn-lg btn-block shadow-sm" type="submit" name="login" id="login">Login</button>
                       
                            <input type="hidden" name="atmpt" id="atmpt" value="<?php echo $atmpt;   ?>">
                        </form>
                        <hr>
